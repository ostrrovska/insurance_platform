...
app = FastAPI(
    ...
    description=(
        "Async event consumer. Handles: CustomerCreated, PolicyCreated, "
        "PolicyActivated (saga success), PolicyCancelled (saga compensated)."
    ),
    version="2.0.0",
    lifespan=lifespan,
)
...
async def list_notifications(db: AsyncSession = Depends(get_db)):
    """Returns last 50 processed events — use this to verify saga outcomes."""
